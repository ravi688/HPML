...
instantiate_declaration_mat4_mul_scalar(int);
...
instantiate_declaration_mat4_mul_scalar(float);
...
instantiate_implementation_mat4_mul_scalar(int);
...
instantiate_implementation_mat4_mul_scalar(float);
